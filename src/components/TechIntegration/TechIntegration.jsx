...
function TechIntegration() {
  return (
    <div className="bg-white w-full sm:grid sm:grid-cols-2 px-8 md:px-24 py-12">
      ...
      <div className="flex flex-col items-center w-full gap-4">
        ...
        {techIntegrationContent.map((item) => {
          return (
            <div className="w-full md:w-4/5 flex gap-4 bg-white rounded-md  border border-indigo-800 p-8 shadow-xl transition hover:border-indigo-500/90 hover:shadow-indigo-500/20">
              <item.icon className="h-10 w-12 md:w-10 text-white bg-indigo-500 rounded-full p-2" />
